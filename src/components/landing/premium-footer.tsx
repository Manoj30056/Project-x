...
export function PremiumFooter() {
  return (
    <footer id="contact" className="relative border-t border-border bg-surface-secondary" role="contentinfo">
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid gap-12 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            {/* Free badge */}
            <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800 px-3 py-1.5">
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-text-tertiary">
            <span>&copy; {new Date().getFullYear()} ENGRAM. All rights reserved.</span>
